...
class WordSearch
{
    static void InsertWord(char[,] grid, string word)
    {
        ...
        switch (direction)
        {
            ...
            case 2: // Insert diagonally (bottom-left to top-right)
                    // Generate random row and column
                    // Checks if word can fit, Inserts the word
                insert = false;
                insertAttempt = 0;
            ...
            case 3: // Insert diagonally (top-right to bottom-left)
                    // Generate random row and column
                    // Checks if word can fit, Inserts the word
                insertAttempt = 0;
                insert = false;
    ...
    static void Main()
    {
        ...
        string wordfileLoc = @"C:DIRECTORY";
        string[] words = { "" };
